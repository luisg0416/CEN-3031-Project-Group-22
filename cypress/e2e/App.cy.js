...
describe('Interaction', () => {
  ...
  it("Should acknowledge user wants quizes", () =>  {
    cy.get('#quizesButton').click()
    cy.url().should('include', '/quizes')
  })
})
...
describe('Interaction: Quizes', () => {
  it("Select a course...", () =>  {
    cy.visit('http://127.0.0.1:3000/quizes')
    cy.get('#cop4600Button').click()
    cy.url().should('include', '/quizes/cop4600')
  })
})
